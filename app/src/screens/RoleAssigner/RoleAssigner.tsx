...
import rolesMetadata from '@skalenetwork/feat/metadata/roles.json';
import { addresses } from '@skalenetwork/feat/network';
import {
  ContractDetailList,
  ContractId,
} from '@skalenetwork/feat/network/contract';
import {
  useRoleAccess,
  useRolesAccess,
  useSContractRead,
...
import { build, CONTRACT } from '@skalenetwork/feat/network/manifest';
import { CrownIcon } from '@skalenetwork/ux/components/Icons/Icons';
            ...
            <div className="flex items-center mt-4 gap-4">
              ...
              <small>
                {parentRoles.isLoading
                  ...
                  : grantOrRevokeRole.isError
                  ? grantOrRevokeRole.error?.message
                  : ''}
              </small>
            </div>
          </form>
